...
// //       bucketName: "uploads", // important for GridFS
// //     };
// //   },
// // });
...
// //   const profileDocs = documentFields
// //   .map(({ field, label }) => {
// //     const doc = user[field];
// //     if (doc && doc.filename) {
// //       return {
...
// //           dob: user.dob || "",
// //           caste: user.caste || "",
// //           profileDocs,  // ✅ Final profile docs list
// //         },
// //       };
// //     });
...
//     await newApp.save();
//     io.emit("application:submitted"); // ✅ Realtime
//     res.status(201).json({ message: "Application submitted", application: newApp });
//   } catch (err) {
//     console.error("❌ Submission failed:", err);
//     res.status(500).json({ message: "Submission failed", error: err.message });
